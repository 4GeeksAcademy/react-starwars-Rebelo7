					...
					<div key={person.uid}>
						<div className="card"  style={{width: '18rem;'}}>
								...
								<div className="card-body">
									...
									<Link to={`/information/people/${person.uid}`}><button className="informationButton">More details</button></Link>
									<button className="rocketButton"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-rocket-takeoff" viewBox="0 0 16 16">
					...
					<div key={planet.uid}>
						<div className="card"  style={{width: '18rem;'}}>
							...
							<div className="card-body">
								...
								<Link to={`/information/planets/${planet.uid}`}><button>More details</button></Link>
							</div>
						</div> 
					</div> ))}
					...
					<div key={starship.uid}>
						<div className="card"  style={{width: '18rem;'}}>
							...
							<div className="card-body">	
								...
								<Link to={`/information/starships/${starship.uid}`}><button>More details</button></Link>
							</div>
						</div>
					</div> ))}
			</div> 
